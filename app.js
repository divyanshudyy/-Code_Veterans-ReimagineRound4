function loader() {
  ...
  document.querySelector(".load-btns").addEventListener("click", function () {
    ...
    gsap.to(loader, {
      opacity: 0,
      duration: 1.5, // Duration of fade out in seconds
      ease: "sine.out",
      onComplete: function () {
    ...
    // GSAP animation to bring in the main content if you need
    gsap.to("#page1,#nav-bar", {
      opacity: 1,
      duration: 1,
      ease: "sine.out",
      delay: 0.8, // Delay start until loader fade out is complete
    });
  });
}
loader();
